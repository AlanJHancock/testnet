...
The Windows receiver package is also served by the archive endpoint at `http://73.79.66.255:48640/receivers/synergy-archive-validator-testnet-v2-windows-receiver.zip`.
