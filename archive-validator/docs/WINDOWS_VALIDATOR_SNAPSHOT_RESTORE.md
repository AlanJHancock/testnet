...
```powershell
Invoke-WebRequest `
  -Uri "http://73.79.66.255:48640/receivers/synergy-archive-validator-testnet-v2-windows-receiver.zip" `
  -OutFile "synergy-archive-validator-testnet-v2-windows-receiver.zip"
```
