...
def runtime_phase(command, *args, timeout=60):
    try:
        result = run([str(RUNTIME), command, "--source-workspace", str(WORKSPACE), "--chain-id", "1264", "--network-id", "synergy-testnet-v2", "--genesis-hash", "f79011f2aaddd40b120d47ba723104fafe3c998d4a17097fae018914b95f1789", *args], timeout=timeout)
